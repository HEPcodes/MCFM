...
{\it Authors:} \\
\vspace*{0.2cm}
J. M. Campbell ({\tt johnmc@fnal.gov}) \\
R. K. Ellis ({\tt ellis@fnal.gov}) \\
\vspace*{2.5cm}
{\it \small Updated: 8th April 2010}
\end{center}
...
values. $M_W$ and $M_Z$ from ref.~\cite{Amsler:2008zzb}.}
\label{ewscheme}
\end{center}
\end{table}
...
152& $ t(\to \nu(p_3)+e^+(p_4)+b(p_5))+\bar{t}(\to \bar{b}(p_6)+q(p_7)+\bar{q}(p_8)) $ & NLO \\
\hline 
156& $t(\to \nu(p_3)+e^+(p_4)+b(p_5))+\bar{t}(\to \bar{b}(p_6) +e^-(p_7)+\bar{\nu}(p_8))+g(p_9) $ & LO \\
\hline 
...
208& $ H(\to W^+(\to \nu(p_3)+e^+(p_4))+W^-(\to e^-(p_5)+\bar{\nu}(p_6)))+f(p_7)$ & NLO \\
209& $ H(-->Z^+(e^-(p_3),e^+(p_4))Z(mu^-(p_5),mu^+(p_6)))+f(p_7)$ & NLO \\
\hline 
\end{tabular}
\end{center}
\end{table}
...
221& $ \tau^-(\to e^-(p_3)+\bar{\nu}_e(p_4)+\nu_\tau(p_5))+\tau^+(\to \bar{\nu}_\tau(p_6)+\nu_e(p_7)+e^+(p_8)) $ & LO \\
\hline 
231& $ f(p_1)+f(p_2) \to t(p_3)+\bar{b}(p_4)+q(p_5) ~[\mbox{t-channel}] $ & NLO \\
236& $ f(p_1)+f(p_2) \to t~(p_3)+b(p_4)+q(p_5) ~[\mbox{t-channel}] $ & NLO \\
\hline 
% 241& $ f(p_1)+f(p_2) \to t(p_3)+\bar{b}(p_4)+f(p_5) ~[\mbox{s-channel}] $ & NLO \\
% 242& $ f(p_1)+f(p_2) \to t(p_3)+\bar{b}(p_4)+f(p_5)+f(p_6) ~[\mbox{s-channel}] $ & LO \\
% 246& $ f(p_1)+f(p_2) \to t~(p_3)+b(p_4)+f(p_5) ~[\mbox{s-channel}] $ & NLO \\
% 247& $ f(p_1)+f(p_2) \to t~(p_3)+b(p_4)+f(p_5)+f(p_6) ~[\mbox{s-channel}] $ & LO \\
% 249& $ f(p_1)+f(p_2) \to f(p_3)+f(p_4)+f(p_5) ~[e^+ e^- \to \mbox{3 jets}] $ & NLO \\
% \hline 
% 251& $ f(p_1)+\gamma(p_2) \to b(p_3)+\bar{b}(p_4) ~[\mbox{DIS}] $ & LO \\
% \hline
...
\hline 
271& $ H(b(p_3)+\bar{b}(p_4))+f(p_5)+f(p_6)~[ \mbox{in heavy top limit} ] $ & NLO \\
272& $ H(\tau^-(p_3)+\tau^+(p_4))+f(p_5)+f(p_6)~[ \mbox{in heavy top limit} ] $ & NLO \\
273& $ H(\to W^+(\nu(p_3),e^+(p_4))W^-(e^-(p_5),\bar \nu(p_6)))+f(p_7)+f(p_8) $ & NLO \\
274& $ H(\to Z^+(e^-(p_3),e^+(p_4))Z(\mu^-(p_5),\mu^+(p_6)))+f(p_7)+f(p_8) $ & NLO \\
275& $ H(b(p_3)+\bar{b}(p_4))+f(p_5)+f(p_6)+f(p_7)~[ \mbox{in heavy top limit} ] $ & LO \\
276& $ H(\tau^-(p_3)+\tau^+(p_4))+f(p_5)+f(p_6)+f(p_7)~[ \mbox{in heavy top limit} ] $ & LO \\
\hline 
...
especially the discussion {\tt Qflag} and {\tt Gflag}. Virtual amplitudes are
taken from ref.~\cite{Bern:1997sc}.
...
\subsection{$t$-channel single top with an explicit $b$-quark, processes 231, 236}
\label{subsec:stopb}
