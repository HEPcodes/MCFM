...
\vspace*{2.5cm}
{\it \small Updated: 7 January 2005}
\end{center}
...
replaced by the file {\tt mcfm.rz} which contains the histograms in {\tt HBOOK}
format.

To obtain the simplest n-tuple output, the flag {\tt creatent} should be set
to {\tt .true.} . In this case, each event that would normally enter a histogram
will instead be recorded as an n-tuple in the file {\tt mcfm.rz}. Each event
...
at present. In this mode, the program will first perofrm a run to obtain the
