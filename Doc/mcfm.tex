...
\vspace*{2cm}
{\it \small Updated: April 1st, 2013}
\end{center}
...
The calculation of process {\tt 283--284} is only available at leading order.
...
Processes {\tt 651--657} correspond to processes {\tt 641--647} but with the Higgs decaying
to two photons.
Processes {\tt 661--667} correspond to processes {\tt 641--647} but with the Higgs decaying
...
253 & $W^+(\to\nu(p_3)+e^+(p_4)) + Z(-->e^-(p_5)+e^+(p_6))+f(p_7)+f(p_8)$ & LO  \\
254 & $W^-(-->e^-(p_3)+\bar{\nu}(p_4))+ Z(-->e^-(p_5)+e^+(p_6))+f(p_7)+f(p_8)$ & LO  \\
255 & $W^+(-->\nu(p_3)+e^+(p_4)) + Z(-->e^-(p_5)+e^+(p_6))+b(p_7)+f(p_8)$ & LO  \\
256 & $W^-(-->e^-(p_3)+\bar{\nu}(p_4))+ Z(-->e^-(p_5)+e^+(p_6))+b(p_7)+f(p_8)$ & LO  \\
259 & $W^+(-->\nu(p_3)+e^+(p_4)) + Z(-->e^-(p_5)+e^+(p_6))+b(p_7)+b~(p_8)$ & LO  \\
260 & $W^-(-->e^-(p_3)+\bar{\nu}(p_4))+ Z(-->e^-(p_5)+e^+(p_6))+b(p_7)+b~(p_8)$ & LO  \\
\hline 
...
567 & $Z(e-(p_3)+e+(p_4))+\bar{t}(-->e^-(p_5)+\bar{\nu}(p_6)+\bar{b}(p_7))+q(p_8)$      & NLO \\
569 & $Z(e-(p_3)+e+(p_4))+\bar{t}(-->e^-(p_5)+\bar{\nu}(p_6)+\bar{b}(p_7))+q(p_8)+f(p_9)$  & LO \\
\hline
...
\section{Version 6.6 changelog}
\label{changelog6.5}
\begin{itemize}
\item Corrected serious bug in implementation of $tZ$ and $tH$
processes.
\end{itemize}

\section{Version 6.5 changelog}
\label{changelog6.5}
\begin{itemize}
