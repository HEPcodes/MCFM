      subroutine chkG_00iiii(k,l,i1,i2,i3,i4,DetGr,f,Gtwiddle,Gtt,
     ...
     . pole=-4*Gtwiddle(k,l)*Dv(dzziiii(z4(i1,i2,i3,i4))+N0,ep-1)
      diff=
     . 20*Gtwiddle(k,l)*Dv(dzziiii(z4(i1,i2,i3,i4))+N0,ep)
     . +pole
     ...
     . write(6,*) 'chkG_00iiii',k,l,i1,i2,i3,i4,diff
c      write(6,*) 'chkG_00iiii',k,l,i1,i2,i3,i4,diff
      enddo
