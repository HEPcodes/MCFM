      subroutine chkF_00iiii(i1,i2,i3,i4,f,Gr,Shat6,N0)
      implicit none
      include 'Dnames.f'
      include 'Dv.f'
      include 'Darraydef.f'
	...
	k=i1
      ...
      diff=Dv(dzziiii(z4(i1,i2,i3,i4))+N0,ep)*den-
     ...
     . -Gr(k,3)*Dv(diiiiii(z6(3,k,i1,i2,i3,i4))+N0,ep)) 

      if ((abs(diff) .gt. weenumber)) 
     . write(6,*) 'chkF_00iiii',i1,i2,i3,i4,diff
