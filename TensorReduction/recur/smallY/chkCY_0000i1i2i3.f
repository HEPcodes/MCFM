      subroutine chkCY_0000i1i2i3(k,l,i1,i2,i3,Xtwiddle,Gtwiddle,
     . Shat7zz,N0)
      implicit none
C---  Expression for Eq. 5.60d
C---  Checks C0000i1i2i3, requires C0000li1i2,C0000li2i3,C0000li3i1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0).or. (i3 .eq. 0)) then
      ...
      do ep=-2,0
      diff=
     .Cv(czzzziii(z3(i1,i2,i3))+N0,ep)*(2d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_0000i1i2i3',k,l,i1,i2,i3,diff
