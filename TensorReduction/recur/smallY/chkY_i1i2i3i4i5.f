      subroutine chkY_i1i2i3i4i5(i,j,i1,i2,i3,i4,i5,f,Xtwiddle,
...
C---  Expression for Eq. 5.61
     ...
     . -2d0*delta(m,i5)*Dv(dzziiii(z4(i1,i2,i3,i4))+N0,ep))
      ...
      diff=Xtwiddle(i,j)*Dv(diiiii(z5(i1,i2,i3,i4,i5))+N0,ep)-
     .  (Gtwiddle(i,j)
     ...
     .   )
      ...
      write(6,*) 'chkY_i1i2i3i4i5',i,j,i1,i2,i3,i4,i5,diff,
     . Xtwiddle(i,j)*Dv(diiiii(z5(i1,i2,i3,i4,i5))+N0,ep)
      endif
