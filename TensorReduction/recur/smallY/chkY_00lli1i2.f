      subroutine chkY_00lli1i2(k,l,i1,i2,Xtwiddle,Gtwiddle,Shat6,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks D00lli1i2, requires D00llli1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0)) then
      ...
      do ep=-2,0
      diff=6d0*Gtwiddle(k,l)*Dv(dzziiii(z4(l,l,i1,i2))+N0,ep)-
     ...
     . write(6,*) 'chkY_00lli1i2',k,l,i1,i2,diff
