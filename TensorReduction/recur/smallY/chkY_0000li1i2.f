      subroutine chkY_0000li1i2(k,l,i1,i2,Xtwiddle,Gtwiddle,Shat7zz,N0)
      implicit none
C---  Expression for Eq. 5.60c
C---  Checks D0000li1i2, requires D0000lli1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0)) then
      ...
      do ep=-2,0
      diff=4d0*Gtwiddle(k,l)*Dv(dzzzziii(z3(l,i1,i2))+N0,ep)-
     ...
     . write(6,*) 'chkY_0000li1i2',k,l,i1,i2,diff
