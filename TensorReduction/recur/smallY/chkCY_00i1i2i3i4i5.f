      subroutine chkCY_00i1i2i3i4i5(k,l,i1,i2,i3,i4,i5,
     . Xtwiddle,Gtwiddle,Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks C00i1i2i3i4i5, requires C00li1i2i3i4
...
C---  Denominator Gtwiddle(k,l)
     ...
     .    ) then
      ...
      do ep=-2,0
      diff=
     .Cv(czziiiii(z5(i1,i2,i3,i4,i5))+N0,ep)*(2d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_00i1i2i3i4i5',k,l,i1,i2,i3,i4,i5,diff
