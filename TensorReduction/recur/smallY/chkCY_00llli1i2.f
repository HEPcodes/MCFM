      subroutine chkCY_00llli1i2(k,l,i1,i2,Xtwiddle,Gtwiddle,Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks C00lli1i2, requires C00lllli1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0)) then
      ...
      do ep=-2,0
      diff=
     .Cv(czziiiii(z5(l,l,l,i1,i2))+N0,ep)*(8d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_00llli1i2',k,l,i1,i2,diff
