      subroutine chkY_00i1i2i3i4i5(k,l,i1,i2,i3,i4,i5,Xtwiddle,Gtwiddle,
     . Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks D00i1i2i3i4i5, requires D00li1i2i3i4
...
C---  Denominator Gtwiddle(k,l)
     ...
     .    ) then
      ...
      do ep=-2,0
      diff=2d0*Gtwiddle(k,l)*Dv(dzziiiii(z5(i1,i2,i3,i4,i5))+N0,ep)-
     ...
     . -Xtwiddle(0,0)*Dv(diiiiiii(z7(k,l,i1,i2,i3,i4,i5))+N0,ep))
      ...
      write(6,*) 'chkY_00i1i2i3i4i5',k,l,i1,i2,i3,i4,i5,diff
      endif
