      subroutine chkY_0000li(k,l,i1,Xtwiddle,Gtwiddle,Shat6zz,N0)
      implicit none
C---  Expression for Eq. 5.58b
C---  Checks D0000li, requires D0000ll
...
C---  Denominator Gtwiddle(k,l)
      ...
      diff=4d0*Gtwiddle(k,l)*Dv(dzzzzii(z2(l,i1))+N0,ep)-
     ...
     . write(6,*) 'chkY_0000li',k,l,i1,diff
