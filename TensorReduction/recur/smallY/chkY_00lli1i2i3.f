      subroutine chkY_00lli1i2i3(k,l,i1,i2,i3,Xtwiddle,Gtwiddle,
     . Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks D00lli1i2i3, requires D00llli1i2
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0) .or. (i3 .eq. 0)) then
      ...
      do ep=-2,0
      diff=6d0*Gtwiddle(k,l)*Dv(dzziiiii(z5(l,l,i1,i2,i3))+N0,ep)-
     ...
     . -Xtwiddle(0,0)*Dv(diiiiiii(z7(k,l,l,l,i1,i2,i3))+N0,ep))
      ...
      write(6,*) 'chkY_00lli1i2i3',k,l,i1,i2,i3,diff
      endif
