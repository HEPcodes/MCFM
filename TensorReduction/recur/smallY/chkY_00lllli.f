      subroutine chkY_00lllli(k,l,i1,Xtwiddle,Gtwiddle,Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60b
C---  Checks D00llli, requires D00lllll
...
C---  Denominator Gtwiddle(k,l)
      ...
      diff=10d0*Gtwiddle(k,l)*Dv(dzziiiii(z5(l,l,l,l,i1))+N0,ep)-
     ...
     . -Xtwiddle(0,0)*Dv(diiiiiii(z7(k,l,l,l,l,l,i1))+N0,ep))
      ...
      write(6,*) 'chkY_00lllli',k,l,i1,diff
      endif
