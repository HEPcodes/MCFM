      subroutine chkCY_00i1i2i3i4(k,l,i1,i2,i3,i4,Xtwiddle,Gtwiddle,
     . Shat6,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks C00i1i2i3i4, requires C00li1i2i3
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1.eq.0) .or. (i2.eq.0) .or. (i3.eq.0) .or. (i4.eq.0)) then
      ...
      do ep=-2,0
      diff=
     .Cv(czziiii(z4(i1,i2,i3,i4))+N0,ep)*(2d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_00i1i2i3i4',k,l,i1,i2,i3,i4,diff
