      subroutine chkCY_00li1i2i3(k,l,i1,i2,i3,
     . Xtwiddle,Gtwiddle,Shat6,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks C00li1i2i3, requires C00lli1i2
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0) .or. (i3 .eq. 0)) then
      ...
      do ep=-2,0
      diff=
     .Cv(czziiii(z4(l,i1,i2,i3))+N0,ep)*(4d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_00li1i2i3',k,l,i1,i2,i3,diff
