      subroutine chkCY_i1i2i3i4i5(i,j,i1,i2,i3,i4,i5,f,Xtwiddle,
...
C---  Expression for Eq. 5.61
     ...
     . -2d0*delta(m,i5)*Cv(czziiii(z4(i1,i2,i3,i4))+N0,ep))
      ...
      diff=
     .Cv(ciiiii(z5(i1,i2,i3,i4,i5))+N0,ep)*Xtwiddle(i,j)-
     .  (Gtwiddle(i,j)
     ...
     . write(6,*) 'chkCY_i1i2i3i4i5',i,j,i1,i2,i3,i4,i5,diff
