      subroutine chkY_0000i1i2i3(k,l,i1,i2,i3,Xtwiddle,Gtwiddle,
     . Shat7zz,N0)
      implicit none
C---  Expression for Eq. 5.60d
C---  Checks D0000i1i2i3, requires D0000li1i2,D0000li2i3,D0000li3i1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0).or. (i3 .eq. 0)) then
      ...
      do ep=-2,0
      diff=2d0*Gtwiddle(k,l)*Dv(dzzzziii(z3(i1,i2,i3))+N0,ep)-
     ...
     . write(6,*) 'chkY_0000i1i2i3',k,l,i1,i2,i3,diff
