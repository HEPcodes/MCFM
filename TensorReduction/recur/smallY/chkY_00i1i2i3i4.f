      subroutine chkY_00i1i2i3i4(k,l,i1,i2,i3,i4,Xtwiddle,Gtwiddle,
     . Shat6,N0)
      implicit none
C---  Expression for extension of Eq. 5.60c
C---  Checks D00i1i2i3i4, requires D00li1i2i3
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1.eq.0) .or. (i2.eq.0) .or. (i3.eq.0) .or. (i4.eq.0)) then
      ...
      do ep=-2,0
      diff=2d0*Gtwiddle(k,l)*Dv(dzziiii(z4(i1,i2,i3,i4))+N0,ep)-
     ...
     . -Xtwiddle(0,0)*Dv(diiiiii(z6(k,l,i1,i2,i3,i4))+N0,ep))
      ...
      write(6,*) 'chkY_00i1i2i3i4',k,l,i1,i2,i3,i4,diff
      endif
