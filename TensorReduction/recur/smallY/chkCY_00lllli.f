      subroutine chkCY_00lllli(k,l,i1,Xtwiddle,Gtwiddle,Shat7,N0)
      implicit none
C---  Expression for extension of Eq. 5.60b
C---  Checks C00llli, requires C00lllll
...
C---  Denominator Gtwiddle(k,l)
      ...
      diff=
     .Cv(czziiiii(z5(l,l,l,l,i1))+N0,ep)*(10d0*Gtwiddle(k,l))-
     ...
     . write(6,*) 'chkCY_00lllli',k,l,i1,diff
