      subroutine chkCY_00i1i2i3(k,l,i1,i2,i3,Xtwiddle,Gtwiddle,Shat5,N0)
      implicit none
C---  Expression for Eq. 5.60d
C---  Checks C00i1i2i3, requires C00li1i2,C00li2i3,C00li3i1
...
C---  Denominator Gtwiddle(k,l)
     ...
     . .or. (i1 .eq. 0) .or. (i2 .eq. 0).or. (i3 .eq. 0)) then
      ...
      do ep=-2,0
      diff=
     .Cv(czziii(z3(i1,i2,i3))+N0,ep)*(2*Gtwiddle(k,l))
     ...
     . write(6,*) 'chkCY_00i1i2i3',k,l,i1,i2,i3,diff
