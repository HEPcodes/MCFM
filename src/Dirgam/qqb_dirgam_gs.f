...
*     Author: J.M. Campbell                                            *
*     October, 2002.                                                   *
*     Modified Nov 2010 By C. Williams
...
c --- remember: nd will count the dipoles
     ...
     & sub24_5v
c     & dummy(-nf:nf,-nf:nf),dummyv(-nf:nf,-nf:nf),
      external qqb_dirgam,qqb_dirgam_gvec!,donothing_gvec,qqb_2g
...
c      if (frag) then
c      call dipsfrag(7,p,3,4,5,sub34_5,msq34_5,qqb_2g)
c      call dipsfrag(8,p,3,5,4,sub35_4,msq35_4,qqb_2g)
c      endif
...
c      if (frag) then 
c      msq(7,j,k)=msq34_5(j,k)*sub34_5
c      msq(8,j,k)=msq35_4(j,k)*sub35_4
c      endif
