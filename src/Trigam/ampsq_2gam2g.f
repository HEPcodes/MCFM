      double precision function ampsq_2gam2g(i1,i2,j3,j4,j5,j6,za,zb)
...
c---
      ...
      double complex amp(2,2,2,2,2,2),
...
c     & cdabs(amp(1,h1,h2,h3,h4,h5)+amp(2,h2,h1,h3,h4,h5))
      ampsq_2gam2g=ampsq_2gam2g
     & +cdabs(amp(1,h1,h2,h3,h4,h5))**2
     & +cdabs(amp(2,h2,h1,h3,h4,h5))**2
     & -1d0/xn**2*cdabs(amp(1,h1,h2,h3,h4,h5)+amp(2,h2,h1,h3,h4,h5))**2
      enddo
      enddo
      enddo
      enddo
...
c      write(6,*) 'ampsq_2gam2g',ampsq_2gam2g*(-9d0)
c      pause
