...
***********************************************
      msq(5,j,k)=msq(5,j,k)+half*(aveqg/avegg)*f2q*(
...
c--- (nf-1) and also the identical one with symmetry factor 1/2
     ...
     .  msq27_1(m,2))*sub27_1(qg)
      ...
      msq(4,j,k)=msq(4,j,k)+dfloat(nf-1)*f4q*(
...
* 2-quark contributions for p5 (off-diagonal) *
***********************************************
      msq(6,j,k)=msq(6,j,k)+half*(aveqg/avegg)*f2q*(
...
c--- f0q subtractions above
     ...
     . +msq_struc56_7v(igggg_c,j,k))*sub56_7v)/2d0

      msq(11,j,k)=msq(11,j,k)+f2q*dfloat(nf)*(
     .+(msq_struc16_5(igggg_b,j,k)
     . +msq_struc16_5(igggg_c,j,k))*sub56_1(gq)
     .-(msq_struc56_1v(igggg_b,j,k)
     . +msq_struc56_1v(igggg_c,j,k))*sub56_1v)/2d0

      msq(14,j,k)=msq(14,j,k)+f2q*dfloat(nf)*(
     .+(msq_struc26_5(igggg_a,j,k)
     . +msq_struc26_5(igggg_b,j,k))*sub56_2(gq)
     .-(msq_struc56_2v(igggg_a,j,k)
     . +msq_struc56_2v(igggg_b,j,k))*sub56_2v)/2d0
