...
c      do h3=1,2
c      do h4=1,2
c      write(6,*) h1,h2,h3,h4,diag(h1,h2,h3,h4)/amp(1,h1,h2,h3,h4)/8d0
c      enddo
c      enddo
c      enddo
c      enddo
...
C     .        amp(3,h1,h2,h3,h4)
C         write(*,*) 'h4gsq:',xn**2*V/2d0*cdabs(amp(1,h1,h2,h3,h4))**2
C     .        ,xn**2*V/2d0*cdabs(amp(2,h1,h2,h3,h4))**2,
C     .        xn**2*V/2d0*cdabs(amp(3,h1,h2,h3,h4))**2
      Hgggg_1256=Hgggg_1256
     . +cdabs(ndep*amp(1,1,h2,h3,h4)+ndem*amp(1,2,h2,h3,h4))**2
      Hgggg_1265=Hgggg_1265
     . +cdabs(ndep*amp(2,1,h2,h3,h4)+ndem*amp(2,2,h2,h3,h4))**2
      Hgggg_1625=Hgggg_1625
     . +cdabs(ndep*amp(3,1,h2,h3,h4)+ndem*amp(3,2,h2,h3,h4))**2
      enddo
      enddo
      enddo
