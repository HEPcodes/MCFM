...
c----after performing a transformation 
      ...
      logical ggZZuse6d
      character*9 st
      double complex bcoeff(8),zab2,funcb34pp,funcb134pp
      double complex funcb134mp,funcb34mp,
...
C     &    j5)/zab2(j2,j3,j4,j1)**2*s(j5,j6) - 2.D0*zb(j3,j4)*zb(j1,j6)
...
C     &    j4,j2)**2*s(j5,j6)*t(j3,j4,j1) - 1d0/2.D0*zb(j4,j6)**2*za(j6
...
c--- This form has been massaged to remove the explicit <2|3+4|1]^3 poles
      double complex function funcb34mp(j1,j2,j3,j4,j5,j6,za,zb)
      implicit none
      include 'constants.f'
      include 'zprods_decl.f'
      include 'sprods_com.f'
      integer j1,j2,j3,j4,j5,j6
      double precision t,sbar134,sbar234,del,s134,s234
      double complex zab2
      double precision IDelta
c---statement functions
      zab2(j1,j2,j3,j4)=za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4)
...
c--- This form is extracted from BDK
      double complex function oldfuncb34mp(j1,j2,j3,j4,j5,j6,za,zb)
      implicit none
      include 'constants.f'
      include 'zprods_decl.f'
      include 'sprods_com.f'
...
c---end statement functions
     ...
     & -2d0*za(j3,j2)*zb(j2,j6)*zb(j1,j4)*zab2(j2,j3,j4,j6)*s(j3,j4)
     ...
     & /zab2(j2,j3,j4,j1)**3
     & +2d0*za(j3,j2)*za(j6,j5)*zb(j4,j6)*zb(j1,j6)*s(j3,j4)*(s234-s134)
     & /zab2(j2,j3,j4,j1)**3
...
c--- This form has been massaged to remove the explicit <2|3+4|1]^3 poles
      double complex function funcb134mp(j1,j2,j3,j4,j5,j6,za,zb)
      implicit none
      include 'constants.f'
      include 'zprods_decl.f'
      include 'sprods_com.f'
      integer j1,j2,j4,j3,j6,j5
      double complex zab2,zbb22
c---statement functions
      zab2(j1,j2,j3,j4)=za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4)
...
c---end statement functions
     ...
     & - 2d0*s(j3,j4)*za(j1,j5)**2*za(j2,j3)*zb(j1,j4)
     &   /za(j1,j2)/za(j5,j6)/zab2(j1,j3,j4,j1)
     & - 2d0*s(j5,j6)*za(j2,j5)*zb(j1,j6)*zb(j2,j4)**2
...
c--- This form is extracted from BDK
      double complex function oldfuncb134mp(j1,j2,j3,j4,j5,j6,za,zb)
      implicit none
      include 'constants.f'
      include 'zprods_decl.f'
      include 'sprods_com.f'
...
c---end statement functions
     ...
     & -2d0*za(j2,j3)*zb(j1,j4)*za(j1,j5)*zab2(j5,j3,j4,j1)*s(j3,j4)
     & /((s(j1,j4)+s(j1,j3))*za(j5,j6)*zab2(j2,j3,j4,j1)**3)

     & +2d0*za(j2,j5)*zb(j2,j4)*zb(j1,j6)*zab2(j2,j5,j6,j4)*s(j5,j6)
