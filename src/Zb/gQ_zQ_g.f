...
C      double precision tanni
      double complex a111,a112,a121,a211,a122,a212,a221,a222,prop
      double complex b111,b112,b121,b211,b122,b212,b221,b222

      double complex qRb_a(2,2,2),qRb_b(2,2,2)
      double complex Rqb_a(2,2,2),Rqb_b(2,2,2)

      double complex qR_a(2,2,2),qR_b(2,2,2)
      double complex Rq_a(2,2,2),Rq_b(2,2,2)

      double complex qbR_a(2,2,2),qbR_b(2,2,2)
      double complex Rbq_a(2,2,2),Rbq_b(2,2,2)

      double complex qbRb_a(2,2,2),qbRb_b(2,2,2)
      double complex Rbqb_a(2,2,2),Rbqb_b(2,2,2)

      double complex qqb_a(2,2,2),qqb_b(2,2,2)

c      double complex qbq_a(2,2,2),qbq_b(2,2,2)
...
c            if (s(5,6) .lt. 4d0*mQsq) goto 20
c--- cut here to prevent the collinear divergence
            if ((abs(j) .eq. flav) .and. (isub .eq. 2)) then
