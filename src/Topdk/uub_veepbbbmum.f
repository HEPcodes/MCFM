      SUBROUTINE SUUB_VEEPBBBMUM(P1,ANS)
C  
...
C  
C FOR PROCESS : u u~ -> ve e+ b b~ mu- vm~ g  
C  
C Crossing   1 is u u~ -> ve e+ b b~ mu- vm~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
             T=UUB_VEEPBBBMUM(P ,NHEL(1,IHEL),JC(1))            
...
C             WRITE(*,*) IHEL,T
      ...
      REAL*8 FUNCTION UUB_VEEPBBBMUM(P,NHEL,IC)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NGRAPHS=   7,NEIGEN=  4,NEXTERNAL=9)   
...
C ----------
      ...
      CALL FVOXXX(W(1,11  ),W(1,17  ),GG ,TMASS   ,TWIDTH  ,W(1,18  ))     
      CALL IOVXXX(W(1,6   ),W(1,18  ),W(1,12  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVOXXX(W(1,5   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL FVOXXX(W(1,20  ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,21  ))    
      CALL FVOXXX(W(1,21  ),W(1,19  ),GG ,TMASS   ,TWIDTH  ,W(1,22  ))     
      CALL IOVXXX(W(1,6   ),W(1,22  ),W(1,12  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,11  ),W(1,19  ),GG ,TMASS   ,TWIDTH  ,W(1,23  ))     
      CALL FVIXXX(W(1,6   ),W(1,9   ),GG ,BMASS   ,ZERO    ,W(1,24  ))     
      CALL IOVXXX(W(1,24  ),W(1,23  ),W(1,12  ),GWF ,AMP(4   ))            
      CALL FVOXXX(W(1,11  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,25  ))     
      CALL FVOXXX(W(1,25  ),W(1,19  ),GG ,TMASS   ,TWIDTH  ,W(1,26  ))     
      CALL IOVXXX(W(1,6   ),W(1,26  ),W(1,12  ),GWF ,AMP(5   ))            
      CALL JVVXXX(W(1,9   ),W(1,19  ),G ,ZERO    ,ZERO    ,W(1,27  ))      
      CALL FVOXXX(W(1,11  ),W(1,27  ),GG ,TMASS   ,TWIDTH  ,W(1,28  ))     
      CALL IOVXXX(W(1,6   ),W(1,28  ),W(1,12  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,23  ),W(1,9   ),GG ,TMASS   ,TWIDTH  ,W(1,29  ))     
      CALL IOVXXX(W(1,6   ),W(1,29  ),W(1,12  ),GWF ,AMP(7   ))            
      include 'skipqqb.f'
      JAMP(   1) = -AMP(   1)
      JAMP(   2) = -AMP(   2)
      JAMP(   3) = -AMP(   3)-AMP(   5)-AMP(   6)
      JAMP(   4) = -AMP(   4)+AMP(   6)-AMP(   7)
      UUB_VEEPBBBMUM = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
          ...
          ENDDO
          UUB_VEEPBBBMUM =UUB_VEEPBBBMUM+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
