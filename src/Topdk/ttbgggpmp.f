      double complex function ttbgggpmp(i1,i2,i3,i4,i5,i6,i7)
      implicit none
      include 'constants.f'
      ...
      mtsq=mt**2
      ttbgggpmp =  + mtsq*s129**(-1) * (  - 1/(za(i1,i2))/(zb(i1,i2))/(
     &    zb(i2,i3))*za(i2,i7)*zb(i1,i3)**2*zb(i4,i3) - 1/(za(i2,i3))/(
     &    zb(i1,i2))/(zb(i2,i3))*za(i2,i7)*zb(i1,i3)**2*zb(i1,i4) )
     ...
     &    i1,i3)*zb(i1,i4)*zb(i7,i3) )
      ttbgggpmp = ttbgggpmp + s129**(-1) * ( 1/(za(i1,i2))/(zb(i1,i2))
     &    /(zb(i2,i3))*za(i2,i5)*za(i6,i7)*zb(i1,i3)**2*zb(i4,i5)*zb(i6
     &    ,i3) + 1/(za(i2,i3))/(zb(i1,i2))/(zb(i2,i3))*za(i2,i5)*za(i6,
     &    i7)*zb(i1,i3)**2*zb(i1,i6)*zb(i4,i5) )
