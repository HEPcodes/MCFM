      double complex function ttbgggmpp(i1,i2,i3,i4,i5,i6,i7)
      implicit none
      include 'constants.f'
      ...
      mtsq=mt**2
      ttbgggmpp =  + mtsq*s129**(-1) * (  - 1/(za(i1,i2))/(za(i2,i3))/(
     &    zb(i1,i5))*za(i1,i3)*za(i1,i7)*zb(i4,i3)*zb(i5,i3) + 1/(za(i1
     &    ,i2))/(zb(i1,i2))/(zb(i1,i5))*za(i1,i7)*zb(i2,i3)*zb(i2,i5)*
     &    zb(i4,i3) - 1/(za(i1,i3))/(za(i2,i3))/(zb(i1,i5))*za(i1,i2)*
     &    za(i1,i7)*zb(i2,i4)*zb(i2,i5) - 1/(za(i1,i3))/(zb(i1,i2))/(
     &    zb(i1,i5))*za(i1,i7)*zb(i2,i3)*zb(i2,i4)*zb(i2,i5) + 1/(za(i2
     &    ,i3))/(zb(i1,i5))*za(i1,i7)*zb(i2,i4)*zb(i5,i3) + 1/(za(i2,i3
     &    ))/(zb(i1,i5))*za(i1,i7)*zb(i2,i5)*zb(i4,i3) )
     ...
     &    ,i7)**2*zb(i2,i4)*zb(i2,i5)*zb(i7,i3) )
      ttbgggmpp = ttbgggmpp + s129**(-1) * ( 1/(za(i1,i2))/(za(i2,i3))
     &    /(zb(i1,i5))*za(i1,i3)*za(i1,i5)*za(i6,i7)*zb(i4,i5)*zb(i5,i3
     &    )*zb(i6,i3) - 1/(za(i1,i2))/(zb(i1,i2))/(zb(i1,i5))*za(i1,i5)
     &    *za(i6,i7)*zb(i2,i3)*zb(i2,i5)*zb(i4,i5)*zb(i6,i3) + 1/(za(i1
     &    ,i3))/(za(i2,i3))/(zb(i1,i5))*za(i1,i2)*za(i1,i5)*za(i6,i7)*
     &    zb(i2,i5)*zb(i2,i6)*zb(i4,i5) + 1/(za(i1,i3))/(zb(i1,i2))/(
     &    zb(i1,i5))*za(i1,i5)*za(i6,i7)*zb(i2,i3)*zb(i2,i5)*zb(i2,i6)*
     &    zb(i4,i5) - 1/(za(i2,i3))/(zb(i1,i5))*za(i1,i5)*za(i6,i7)*zb(
     &    i2,i5)*zb(i4,i5)*zb(i6,i3) - 1/(za(i2,i3))/(zb(i1,i5))*za(i1,
     &    i5)*za(i6,i7)*zb(i2,i6)*zb(i4,i5)*zb(i5,i3) )
