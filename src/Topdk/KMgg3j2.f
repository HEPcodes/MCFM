      subroutine KMgg3j2(mt,zp1,zp2,zp3,zp4,e1,e2,Ubm,Vm,
     & KMgg3j2ab,KMgg3j2ba,KMgg3j2dd)
      implicit none
      include 'constants.f'
      include 'eplog.f'
...
C-----This is an implementation of KM, Eq. (2.22)
      ...
      double complex KMgg3j2ab,KMgg3j2ba,KMgg3j2dd

      KMgg3j2ab=-2d0/3d0*eplog*Bs(zp1,zp2,zp3,zp4,e1,e2,Ubm,Vm)
