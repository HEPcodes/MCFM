      subroutine KMgg2e1(mt,zp1,zp2,zp3,zp4,e1,e2,Ubm,Vm,
     & KMgg2e1ab,KMgg2e1ba,KMgg2e1dd)
      implicit none
      include 'constants.f'
      include 'eplog.f'
...
C-----This is an implementation of KM, Eq. (2.20)
      ...
      double complex KMgg2e1ab,KMgg2e1ba,KMgg2e1dd

      KMgg2e1ba=-2d0/3d0*eplog*Bt(zp1,zp2,zp3,zp4,e1,e2,Ubm,Vm)
