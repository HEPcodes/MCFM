      double complex function ttbgggppm(i1,i2,i3,i4,i5,i6,i7)
      implicit none
      include 'constants.f'
      ...
      mtsq=mt**2
      ttbgggppm =  + mtsq*s129**(-1) * ( 1/(za(i1,i2))/(za(i1,i3))/(zb(
     &    i6,i3))*za(i2,i3)*za(i7,i3)*zb(i2,i4)*zb(i2,i6) + 1/(za(i1,i2
     &    ))/(za(i2,i3))/(zb(i6,i3))*za(i1,i3)*za(i7,i3)*zb(i1,i4)*zb(
     &    i1,i6) + 1/(za(i1,i2))/(zb(i6,i3))*za(i7,i3)*zb(i1,i4)*zb(i2,
     &    i6) + 1/(za(i1,i2))/(zb(i6,i3))*za(i7,i3)*zb(i1,i6)*zb(i2,i4)
     &     + 1/(za(i1,i3))/(zb(i2,i3))/(zb(i6,i3))*za(i7,i3)*zb(i1,i2)*
     &    zb(i2,i4)*zb(i2,i6) + 1/(za(i2,i3))/(zb(i2,i3))/(zb(i6,i3))*
     &    za(i7,i3)*zb(i1,i2)*zb(i1,i4)*zb(i2,i6) )
     ...
     &    zb(i6,i3))*za(i7,i3)**2*zb(i1,i4)*zb(i6,i7) )
      ttbgggppm = ttbgggppm + s129**(-1) * (  - 1/(za(i1,i2))/(za(i1,i3
     &    ))/(zb(i6,i3))*za(i2,i3)*za(i5,i3)*za(i6,i7)*zb(i2,i6)**2*zb(
     &    i4,i5) - 1/(za(i1,i2))/(za(i2,i3))/(zb(i6,i3))*za(i1,i3)*za(
     &    i5,i3)*za(i6,i7)*zb(i1,i6)**2*zb(i4,i5) - 2.D0/(za(i1,i2))/(
     &    zb(i6,i3))*za(i5,i3)*za(i6,i7)*zb(i1,i6)*zb(i2,i6)*zb(i4,i5)
     &     - 1/(za(i1,i3))/(zb(i2,i3))/(zb(i6,i3))*za(i5,i3)*za(i6,i7)*
     &    zb(i1,i2)*zb(i2,i6)**2*zb(i4,i5) - 1/(za(i2,i3))/(zb(i2,i3))
     &    /(zb(i6,i3))*za(i5,i3)*za(i6,i7)*zb(i1,i2)*zb(i1,i6)*zb(i2,i6
     &    )*zb(i4,i5) )
