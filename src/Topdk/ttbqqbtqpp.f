      double complex function ttbqqbtqpp(k1,k2,k3,k4,k5,k6,k7)
      implicit none
      include 'constants.f'
      ...
      mtsq=mt**2
      ttbqqbtqpp =  + mtsq*s129**(-1) * ( 1/(za(k1,k2))/(za(k5,k3))/(
     &    zb(k1,k2))*za(k1,k3)*za(k5,k7)*zb(k2,k3)*zb(k4,k3) + 1/(za(k1
     &    ,k2))/(za(k5,k3))/(zb(k1,k2))*za(k1,k5)*za(k1,k7)*zb(k1,k3)*
     &    zb(k2,k4) - 1/(za(k1,k2))/(za(k5,k3))/(zb(k1,k2))*za(k1,k5)*
     &    za(k1,k7)*zb(k1,k4)*zb(k2,k3) - 1/(za(k1,k2))/(za(k5,k3))/(
     &    zb(k1,k2))*za(k1,k5)*za(k2,k7)*zb(k2,k3)*zb(k2,k4) + 1/(za(k1
     &    ,k2))/(za(k5,k3))/(zb(k1,k2))*za(k1,k7)*za(k2,k5)*zb(k2,k3)*
     &    zb(k2,k4) + 1/(za(k2,k3))*za(k1,k7)*zb(k4,k3) + 1/(za(k2,k3))
     &    /(za(k5,k3))*za(k1,k7)*za(k2,k5)*zb(k2,k4) )
     ...
     &    k5,k3))/(zb(k1,k2))*za(k1,k7)*za(k5,k7)*zb(k2,k4)*zb(k7,k3) )
      ttbqqbtqpp = ttbqqbtqpp + s129**(-1) * (  - 1/(za(k1,k2))/(za(k5,
     &    k3))/(zb(k1,k2))*za(k1,k5)**2*za(k6,k7)*zb(k1,k3)*zb(k2,k6)*
     &    zb(k4,k5) + 1/(za(k1,k2))/(za(k5,k3))/(zb(k1,k2))*za(k1,k5)**
     &    2*za(k6,k7)*zb(k1,k6)*zb(k2,k3)*zb(k4,k5) - 1/(za(k2,k3))*za(
     &    k1,k5)*za(k6,k7)*zb(k4,k5)*zb(k6,k3) - 1/(za(k2,k3))/(za(k5,
     &    k3))*za(k1,k5)*za(k2,k5)*za(k6,k7)*zb(k2,k6)*zb(k4,k5) )
