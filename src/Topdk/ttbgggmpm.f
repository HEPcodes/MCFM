      double complex function ttbgggmpm(i1,i2,i3,i4,i5,i6,i7)
      implicit none
      include 'constants.f'
      ...
      mtsq=mt**2
      ttbgggmpm =  + mtsq*s129**(-1) * ( 1/(za(i1,i2))/(za(i2,i3))/(zb(
     &    i1,i2))*za(i1,i3)**2*za(i7,i3)*zb(i2,i4) + 1/(za(i1,i2))/(za(
     &    i2,i3))/(zb(i2,i3))*za(i1,i3)**2*za(i1,i7)*zb(i2,i4) )
     ...
     &    i7,i3)*zb(i2,i4)*zb(i2,i5) )
      ttbgggmpm = ttbgggmpm + s129**(-1) * (  - 1/(za(i1,i2))/(za(i2,i3
     &    ))/(zb(i1,i2))*za(i1,i3)**2*za(i5,i3)*za(i6,i7)*zb(i2,i6)*zb(
     &    i4,i5) - 1/(za(i1,i2))/(za(i2,i3))/(zb(i2,i3))*za(i1,i3)**2*
     &    za(i1,i5)*za(i6,i7)*zb(i2,i6)*zb(i4,i5) )
