...
c--- reduce momenta to top and anti-top sums
      ...
      mbar12=0d0
CDTS (5.45,5.77)
      mbar13=mass2/dSqrt(-2d0*Dot(pt,1,3))
      mbar23=mass2/dSqrt(-2d0*Dot(pt,2,3))
      mbar14=mass2/dSqrt(-2d0*Dot(pt,1,4))
      mbar24=mass2/dSqrt(-2d0*Dot(pt,2,4))
CDTS (5.5)
      mbar34=mass2/dSqrt(Q34sq)
        
      xl12=dlog(+2d0*Dot(pt,1,2)/musq)
      xl13=dlog(-2d0*Dot(pt,1,3)/musq)
      xl14=dlog(-2d0*Dot(pt,1,4)/musq)
      xl23=dlog(-2d0*Dot(pt,2,3)/musq)
      xl24=dlog(-2d0*Dot(pt,2,4)/musq)
