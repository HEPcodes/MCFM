...
*      COMMON/AA/PI,W,Q,QCDL,NF,MODE
      DOUBLE PRECISION RMT,RGT,RMW,RGW,RMB,RMTLO,RMTUP,DOTKS
      COMMON/PARS/RMT,RGT,RMW,RGW,RMB,RMTLO,RMTUP
      COMMON/MOM/PLAB(4,10)
      DOUBLE PRECISION GW,GS
      COMMON/COUPS/GW,GS
      COMMON/CSTD/SPL,SMN
      DATA INIT/0/
...
c--- modified by JC, 24/7/08 to remove width from propagators
c      ZDEN1=ZD0*DCMPLX(D1345-RMT2,RMGT)
c      ZDEN2=ZD0*DCMPLX(D1678-RMT2,RMGT)
      ZDEN1=ZD0*DCMPLX(D1345-RMT2,0d0)
      ZDEN2=ZD0*DCMPLX(D1678-RMT2,0d0)
      D12=DOTKS(1,2)
      ZDEN3=ZD0*2.D0*D12
*
* THE SPINOR PARTS
