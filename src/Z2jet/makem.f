...
C     Eq. A.23 with a factor of 2*i*e^2*g^3/s removed
      ...
      include 'prods.f'
      include 'hardscale.f'
      integer fa,fb,ha,hb,hq,Qh,hg,lh,i1,i2,i3,i4,i5,i6,i7,f(7),j
      double precision vl(2),gq(2,2)
      double complex m1_1234(2,2,2,2,2,2),m2_1234(2,2,2,2,2,2),
     ...
     . prop
      ...
      prop=s(i6,i7)/dcmplx((s(i6,i7)-zmass**2),zmass*zwidth)
