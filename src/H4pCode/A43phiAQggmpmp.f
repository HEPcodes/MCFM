      double complex function A43phiAQggmpmp(j1,j2,j3,j4,za,zb)
      implicit none
      include 'constants.f'
...
c---  arXiv:0906.0008 [hep-ph].
      double complex function A43phiAQggmpmp_unsym(j1,j2,j3,j4,za,zb)
      implicit none
      include 'constants.f'
      include 'zprods_decl.f'
      ...
      include 'scale.f'
      include 'epinv.f'
      double complex V5L,V6L,A0phiAQggmpmp,lnrat
