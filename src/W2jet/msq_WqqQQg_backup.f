      subroutine msq_WqqQQg(i1,i2,i3,i4,i5,i6,i7,MN)
************************************************************************
*     Author: R.K. Ellis                                               *
*     March, 2001.                                                     *
...
************************************************************************
      ...
      include 'prods.f'
      include 'hardscale.f'
      integer Qh,hq,hg,lh,f1,f2,f3,f4,i1,i2,i3,i4,i5,i6,i7,j
     ...
     . Mz(5,5,5,5),Mxx(5,5,5,5),Mxy(5,5,5,5),gq,gl,Qg
...
c--- DEBUG
     ...
     . +cdabs(mb1_1234(f1,f2,f3,f4,hq,Qh,hg))**2
     . +cdabs(mb2_1234(f1,f2,f3,f4,hq,Qh,hg))**2
     . +cdabs(mb1_3214(f3,f4,f1,f2,Qh,hq,hg))**2
     . +cdabs(mb2_3214(f3,f4,f1,f2,Qh,hq,hg))**2
     . +cdabs(mb1_1432(f1,f2,f3,f4,hq,Qh,hg))**2
     . +cdabs(mb2_1432(f1,f2,f3,f4,hq,Qh,hg))**2
     . +cdabs(mb1_3412(f3,f4,f1,f2,Qh,hq,hg))**2
     . +cdabs(mb2_3412(f3,f4,f1,f2,Qh,hq,hg))**2
      D(f1,f2,f3,f4)=D(f1,f2,f3,f4)+two*Dreal(
     .+mb1_1234(f1,f2,f3,f4,hq,Qh,hg)
     .*Dconjg(mb2_1234(f1,f2,f3,f4,hq,Qh,hg))
     .+mb1_3214(f3,f4,f1,f2,Qh,hq,hg)
     .*Dconjg(mb2_3214(f3,f4,f1,f2,Qh,hq,hg))
     .+mb1_1432(f1,f2,f3,f4,hq,Qh,hg)
     .*Dconjg(mb2_1432(f1,f2,f3,f4,hq,Qh,hg))
     .+mb1_3412(f3,f4,f1,f2,Qh,hq,hg)
     .*Dconjg(mb2_3412(f3,f4,f1,f2,Qh,hq,hg)))
     ...
     .+mb1_1234(f1,f2,f3,f4,hq,Qh,hg)
     .*Dconjg(mb1_1432(f1,f2,f3,f4,hq,Qh,hg))
     .+mb2_1234(f1,f2,f3,f4,hq,Qh,hg)
     .*Dconjg(mb2_3214(f3,f4,f1,f2,Qh,hq,hg))
     .+mb1_3412(f3,f4,f1,f2,Qh,hq,hg)
     .*Dconjg(mb1_3214(f3,f4,f1,f2,Qh,hq,hg))
...
c--- DEBUG
c      M0(f1,f2,f3,f4)=
c     . B(f1,f2,f3,f4)+C(f1,f2,f3,f4)
c     .+E(f1,f2,f3,f4)
c      Mx(f1,f2,f3,f4)=-0.5d0
c     . *(3d0*C(f1,f2,f3,f4)+2d0*E(f1,f2,f3,f4)
c     .      +B(f1,f2,f3,f4))
c      My(f1,f2,f3,f4)=A(f1,f2,f3,f4)+D(f1,f2,f3,f4)
c      Mz(f1,f2,f3,f4)=F(f1,f2,f3,f4)+G(f1,f2,f3,f4)
c      Mxx(f1,f2,f3,f4)=0.25d0*(2d0*C(f1,f2,f3,f4)
c     .                            +E(f1,f2,f3,f4))
c      Mxy(f1,f2,f3,f4)=-0.5d0*(F(f1,f2,f3,f4)
c     .                        +D(f1,f2,f3,f4))

c      MN(f1,f2,f3,f4)=
c     . CF**3*xn*(M0(f1,f2,f3,f4)+x*Mx(f1,f2,f3,f4)
c     . +y*My(f1,f2,f3,f4)+z*Mz(f1,f2,f3,f4)
c     . +x**2*Mxx(f1,f2,f3,f4)+x*y*Mxy(f1,f2,f3,f4))

c      if ((f1.eq.1).and.(f3.eq.2).and.(MN(f1,f2,f3,f4).gt.0d0)) then
c      write(*,*) '12 f2,f4,hq,Qh,hg',f2,f4,hq,Qh,hg,
c     . 0.5d0*(gsq**3*gwsq**2*8d0)*(0.25d0/9d0)*MN(f1,f2,f3,f4)
c      endif
c      if ((f1.eq.2).and.(f3.eq.1).and.(MN(f1,f2,f3,f4).gt.0d0)) then
c      write(*,*) '21 f2,f4,hq,Qh,hg',f2,f4,hq,Qh,hg,
c     . 0.5d0*(gsq**3*gwsq**2*8d0)*(0.25d0/9d0)*MN(f1,f2,f3,f4)
c      endif
c--- DEBUG
