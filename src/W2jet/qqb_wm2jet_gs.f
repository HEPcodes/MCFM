...
C-- G-Qbar
     ...
     .     +(xn-one/xn)*(0.5d0*m15_2x(0,1,-1,-1,2)*Vckm
     .                        +m15_2x(0,3,-1,-1,4)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m15_2x(1,1,-1,-1,2)*Vckm
     .                        +m15_2x(1,3,-1,-1,4)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m15_2x(2,1,-1,-1,2)*Vckm
     .                        +m15_2x(2,3,-1,-1,4)*(2d0-Vckm)))
          msq(19,j,k)=msq(19,j,k)+sub16_2(qg)*(aveqg/aveqq)*(
     .     +(xn-one/xn)*(0.5d0*m16_2x(0,1,-1,-1,2)*Vckm
     .                        +m16_2x(0,1,-1,-3,4)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m16_2x(1,1,-1,-1,2)*Vckm
     .                        +m16_2x(1,1,-1,-3,4)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m16_2x(2,1,-1,-1,2)*Vckm
...
c---------Q-G
     ...
     .     +(xn-one/xn)*(0.5d0*m25_1x(0,2,-2,2,-1)*Vckm
     .                        +m25_1x(0,2,-2,4,-3)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m25_1x(1,2,-2,2,-1)*Vckm
     .                        +m25_1x(1,2,-2,4,-3)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m25_1x(2,2,-2,2,-1)*Vckm
     .                        +m25_1x(2,2,-2,4,-3)*(2d0-Vckm)))
          msq(22,j,k)=msq(22,j,k)+sub26_1(qg)*(aveqg/aveqq)*(
     .     +(xn-one/xn)*(0.5d0*m26_1x(0,2,-2,2,-1)*Vckm
     .                        +m26_1x(0,2,-4,2,-3)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m26_1x(1,2,-2,2,-1)*Vckm
     .                        +m26_1x(1,2,-4,2,-3)*(2d0-Vckm))
     .     +(xn-one/xn)*(0.5d0*m26_1x(2,2,-2,2,-1)*Vckm
     ...
     .     +m16_2vx(0,0,2,-1))
          msq(21,j,k)=msq(21,j,k)
     .          +(2d0-Vckm)*sub15_2(gq)*(aveqg/avegg)*(
     .     +m15_2x(0,0,0,4,-3)+m15_2x(1,0,0,4,-3)+m15_2x(2,0,0,4,-3))
     .          +(2d0-Vckm)*sub15_2v*(aveqg/avegg)*(
     .     +m15_2vx(0,0,4,-3))
          endif
C-- Qbar-G
        elseif (j .lt. 0) then
