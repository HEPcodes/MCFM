      double complex function Fcc_qpgpgmqm(j1,j2,j3,j4,j5,j6,za,zb) 
      implicit none
     ...
     .(2d0*za(j1,j2)*za(j5,j6)*(za(j2,j4)*zb(j1,j2)+za(j3,j4)*zb(j1,j3))
     .*
     ...
     .(2d0*za(j1,j2)*(za(j2,j4)*zb(j1,j2)+za(j3,j4)*zb(j1,j3))*
     .(-(za(j2,j3)*zb(j1,j3))-za(j2,j4)*zb(j1,j4))*zb(j3,j4)*zb(j5,j6))-
     .(2d0*za(j1,j3)*(-(za(j1,j3)*zb(j1,j6))-za(j2,j3)*zb(j2,j6))*
     ...
     .(za(j1,j2)*za(j2,j3)*(za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4))*
     .zb(j5,j6)*t(j1,j2,j3)))+
     .(2d0*zb(j2,j4)*(za(j3,j5)*zb(j2,j3)+za(j4,j5)*zb(j2,j4))*
