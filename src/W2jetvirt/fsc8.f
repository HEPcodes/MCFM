     ...
     .(2d0*za(j1,j4)*za(j2,j3)*za(j3,j4)*za(j5,j6))+
     ...
     .(2d0*s(j5,j6)**2*za(j1,j4)*za(j2,j3)*za(j3,j4))+
     ...
     .(za(j1,j4)*za(j2,j3)*za(j3,j4)*za(j5,j6)))-
     .(za(j2,j4)*(-(za(j1,j5)*za(j2,j4))+2d0*za(j1,j4)*za(j2,j5))*
     ...
     .(2d0*za(j1,j4)*za(j3,j4)*za(j5,j6)*t(j2,j3,j4)**2)
