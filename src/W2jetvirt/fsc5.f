     ...
     .(za(j1,j3)*za(j3,j5)**2)/
     .(2d0*za(j1,j2)*za(j1,j4)*za(j2,j3)*za(j3,j4)*za(j5,j6))+
     ...
     .(2d0*s(j5,j6)**2*za(j1,j2)*za(j1,j4)*za(j2,j3)*za(j3,j4))+
     ...
     .(2d0*za(j1,j2)*za(j2,j4)*za(j5,j6)*t(j2,j3,j4)**2)+
     ...
     .(2d0*za(j1,j4)*za(j2,j4)*za(j5,j6)*t(j2,j3,j4)**2)-
     .(za(j1,j5)*za(j2,j4)*za(j3,j5)*zb(j2,j4)**2)/
     .(2d0*za(j1,j2)*za(j1,j4)*za(j5,j6)*t(j1,j2,j4)*t(j2,j3,j4))-
     .(zb(j2,j4)*(za(j1,j2)*zb(j2,j6)+za(j1,j4)*zb(j4,j6))*
     .(-(za(j2,j3)*zb(j2,j6))+za(j3,j4)*zb(j4,j6)))/
     .(2d0*za(j1,j2)*za(j1,j4)*zb(j5,j6)*t(j1,j2,j4)*t(j2,j3,j4))
      return
      end
