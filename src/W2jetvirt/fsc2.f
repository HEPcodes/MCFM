      double complex function Fsc2(j1,j2,j3,j4,j5,j6,za,zb) 
      implicit none
      include 'constants.f'
      include 'sprodx.f'
      include 'dprodx.f'
      ...
      double precision t  
      Fsc2= 
     .za(j3,j5)**2/(2d0*za(j1,j2)*za(j2,j3)*za(j5,j6)*zb(j3,j4))+
     .zb(j2,j6)**2/(2d0*za(j1,j2)*zb(j2,j3)*zb(j3,j4)*zb(j5,j6))-
     ...
     .(2d0*za(j1,j2)*za(j2,j3)*(za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4))
     .*
     ...
     .(2d0*za(j5,j6)*zb(j2,j3)*zb(j3,j4)*
