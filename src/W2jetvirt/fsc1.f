     ...
     .t(j2,j3,j4))+(L0(-t(j2,j3,j4),-s(j3,j4))*za(j1,j5)**2*za(j2,j4)*zb
     .(j2,j3)*
     .zb(j3,j4)*t(j2,j3,j4))/
     ...
     .(za(j1,j2)*zb(j2,j4)+za(j1,j3)*zb(j3,j4)))+
     .(za(j1,j5)**2*zb(j1,j3)*(za(j1,j2)*zb(j2,j3)-za(j1,j4)*zb(j3,j4))*
     .(-(L1(-s(j5,j6),-t(j2,j3,j4))*zb(j1,j3))/(2d0*zb(j2,j3)*t(j2,j3,j4
     .)**2)+
     ...
     .)/((s(j1,j2)**2-2d0*s(j1,j2)*s(j3,j4)+s(j3,j4)**2-2d0*s(j1,j2)*s(j
     .5,j6)-
     .2d0*s(j3,j4)*s(j5,j6)+s(j5,j6)**2)*
     .(-(za(j1,j3)*zb(j2,j3))-za(j1,j4)*zb(j2,j4)))+
     .((-(za(j2,j3)*zb(j1,j3))-za(j2,j4)*zb(j1,j4))*
