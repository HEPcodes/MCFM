...
************************************************************************
     ...
     . mc2,ms2,qsq,s,t,u,xsn,xsd,xs
      double complex trc,trg,trs,trsgc,zppm,Appm,old
     ...
     &   *cDs)+2*ms2*(ms2-mc2)*trc*cDg**5)/(mc*ms*cDg**2*gDs**3)/4.0d+0+
     &   Appm
     ...
     &   2*trc*cDg**6)/(mc*ms*cDg**2*gDs**3)/4.0d+0+Appm
