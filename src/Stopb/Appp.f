...
************************************************************************
     ...
     . mc2,ms2,qsq,s,t,u,xsn,xsd,xs
      double complex trc,trg,trs,trsgc,zppp,Appp,old
     ...
     &   **5)/(mc*cDg**2*(2*cDg+mc2)*gDs**2)/1.2d+1+Appp
     ...
     &   s)*(ms+mc)*trc*cDg**4)/(mc*cDg**2*gDs**2)/4.0d+0+Appp
