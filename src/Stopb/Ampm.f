...
************************************************************************
     ...
     . mc2,ms2,qsq,s,t,u,xsn,xsd,xs
      double complex trc,trg,trs,trsgc,zmpm,Ampm,old
     ...
     &   )*cDg**5)*lVc/(ms*cDg**3*gDs**2)/4.0d+0+Ampm
     ...
     &   )*trsgc)+mc2*trg*gDs**2*(2*lRs1+2*lRc1-1))/(cDg**2*gDs)/4.0d+0
     ...
     &   (2*gDs+ms2)**2)/(mc*cDg*(2*gDs+ms2)**2)/2.0d+0
     ...
     &   c)-2*ms2*(trs+trg)*cDg**6)/(mc*ms*cDg**3*gDs**2)/4.0d+0+Ampm
