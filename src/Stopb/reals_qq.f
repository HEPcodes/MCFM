...
c--- bottom quark.
      ...
      double precision bDg,tDg,bDq2,tDq2,mq,ma,mq2,ma2
      double complex amp(2,2,2)
 
 
      mq2 = mq**2
      ma2 = ma**2
      bDq2=s(q2,b1)/2d0+s(p,q2)*ma2/2d0/s(p,b1)
      tDq2=s(q2,t1)/2d0+s(p,q2)*mq2/2d0/s(p,t1)
      bDg =s(q1,q2)/2d0+s(q1,b1)/2d0+s(q1,p)*ma2/2d0/s(p,b1)+bDq2
