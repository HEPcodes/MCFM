      double complex function aqqb_zbb(i1,i2,i3,i4,i5,i6)
...
c--- statement function
      ...
      prop=s(i5,i6)*s(i3,i4)
      aqqb_zbb=
     & +zb(i1,i4)*za(i5,i2)*t2a(i3,i1,i4,i6)/(prop*s256)
     & +za(i3,i2)*zb(i6,i1)*t2a(i5,i2,i3,i4)/(prop*s234)
