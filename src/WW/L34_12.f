...
c-----first line
      L34_12=1.5d0*del56*(t134-t234)*z2(j3,j1,j2,j4)*z2(j6,j1,j2,j5)
     . /(z2(j2,j5,j6,j1)*Del3**2)
      L34_12=L34_12+1.5d0*za(j3,j6)*bit1/(z2(j2,j5,j6,j1)*Del3)

c----second line
      L34_12=L34_12+0.5d0*za(j3,j4)*zb(j4,j5)*bit2
