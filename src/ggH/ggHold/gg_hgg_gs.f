...
c--- identical quark contribution
     ...
     . +(xn-two/xn)*msq_struc27_5(iqq_a,m,n))
      ...
      m=j/abs(j)
      n=k/abs(k)
      msq(4,j,k)=msq(4,j,k)+0.5d0*(aveqq/aveqg)*f4q*(
     .+(+msq_struc26_1(igg_ab,m,0)+msq_struc26_1(igg_ba,m,0)
     .  +msq_struc26_1(igg_sym,m,0))*sub26_1(gq)
     .+(+msq_struc26_1v(igg_ab,m,0)+msq_struc26_1v(igg_ba,m,0)
     .  +msq_struc26_1v(igg_sym,m,0))*sub26_1v)
      msq(5,j,k)=msq(5,j,k)+0.5d0*(aveqq/aveqg)*f4q*(
     .+(+msq_struc15_2(igg_ab,0,n)+msq_struc15_2(igg_ba,0,n)
     .  +msq_struc15_2(igg_sym,0,n))*sub15_2(gq)
     .+(+msq_struc15_2v(igg_ab,0,n)+msq_struc15_2v(igg_ba,0,n)
     .  +msq_struc15_2v(igg_sym,0,n))*sub15_2v)
       msq(6,j,k)=msq(6,j,k)+0.5d0*(aveqq/aveqg)*f4q*(
     ...
     .  +msq_struc25_1v(igg_sym,m,0))*sub25_1v)
      msq(3,j,k)=msq(3,j,k)+0.5d0*(aveqq/aveqg)*f4q*(
...
**********************************
     ...
     .  +msq_struc15_2v(igg_sym,0,n))*sub15_2v)
      ...
      msq(21,j,k)=msq(21,j,k)+2d0*dfloat(nf)*f4q*(
...
***********************************************
      msq(5,j,k)=msq(5,j,k)+4d0/xn*f2q*(
...
c--- (nf-1) and also the identical one with symmetry factor 1/2
      nfactor=dfloat(nf-1)+half
      
      m=+1
      msq(20,j,k)=msq(20,j,k)+nfactor*f4q*(
     .+(msq_struc67_5(igg_ab,m,0)+msq_struc67_5(igg_ba,m,0)
     . +msq_struc67_5(igg_sym,m,0))*sub67_5(gq)
     .-(msq_struc67_5v(igg_ab,m,0)+msq_struc67_5v(igg_ba,m,0)
     . +msq_struc67_5v(igg_sym,m,0))*sub67_5v)

      msq(5,j,k)=msq(5,j,k)+(aveqg/avegg)*nfactor/dfloat(nf)*f4q*(
     ...
     . +msq_struc15_2v(igg_sym,0,k))*sub15_2v)
      ...
      msq(2,j,k)=msq(2,j,k)+dfloat(nf-1)*f4q*(
     .  msq27_1(m,2))*sub27_1(qg)

      msq(4,j,k)=msq(4,j,k)+nfactor*f4q*(
...
****************************************************************
     ...
     .+(msq_struc75_6(igg_ab,m,0)+msq_struc75_6(igg_ba,m,0)
     . +msq_struc75_6(igg_sym,m,0))*sub75_6(gq)
     .-(msq_struc75_6v(igg_ab,m,0)+msq_struc75_6v(igg_ba,m,0)
     . +msq_struc75_6v(igg_sym,m,0))*sub75_6v)
      msq(2,j,k)=msq(2,j,k)+f4q*(
     .  msq27_1(m,1))*sub27_1(qg)
      msq(4,j,k)=msq(4,j,k)+half/dfloat(nf-1)*f4q*(
     .  msq_struc26_1(iqr,m,-m))*sub26_1(qg)
      msq(6,j,k)=msq(6,j,k)+half*f4q*(
     .  +msq_struc25_1(iqq_a,m,-1)+msq_struc25_1(iqq_b,m,-1)
     .  +msq_struc25_1(iqq_i,m,-1))*sub25_1(qg)
      msq(3,j,k)=msq(3,j,k)+(aveqg/avegg)*half/dfloat(nf)*f4q*(
...
**********************************
     ...
     . msq_struc57_6(igg_ab,m,n),msq_struc57_6(igg_sym,m,n),
     . sub57_6(qq))
      msq(8,j,k)=msq(8,j,k)+f2q*0.5d0*half*sub2q3g_if(
     . msq_struc27_6(igg_ba,m,n),msq_struc27_6(igg_sym,m,n),
     . sub67_2(gg),
     . msq_struc67_2v(igg_ba,m,n),msq_struc67_2v(igg_sym,m,n),sub67_2v)
      msq(8,j,k)=msq(8,j,k)+f2q*0.5d0*sub2q3g_fi(
     . msq_struc27_6(igg_ba,m,n),msq_struc27_6(igg_sym,m,n),
     . sub27_6(qq))

      msq(10,j,k)=msq(10,j,k)+f2q*0.5d0*sub2q3g_ff(
...
**********************************
     ...
     . msq_struc56_7(igg_ab,m,n),msq_struc56_7(igg_sym,m,n),
     . sub56_7(qq))
      msq(12,j,k)=msq(12,j,k)+f2q*0.5d0*half*sub2q3g_if(
     . msq_struc26_7(igg_ba,m,n),msq_struc26_7(igg_sym,m,n),
     . sub76_2(gg),
     . msq_struc76_2v(igg_ba,m,n),msq_struc76_2v(igg_sym,m,n),sub76_2v)
      msq(12,j,k)=msq(12,j,k)+f2q*0.5d0*sub2q3g_fi(
     . msq_struc26_7(igg_ba,m,n),msq_struc26_7(igg_sym,m,n),
     . sub26_7(qq))

      msq(14,j,k)=msq(14,j,k)+f2q*0.5d0*sub2q3g_ff(
...
* 2-quark contributions for p5 (off-diagonal) *
***********************************************
      msq(6,j,k)=msq(6,j,k)+4d0/xn*f2q*(
...
c--- (nf-1) and also the identical one with symmetry factor 1/2
      ...
      n=+1
      msq(20,j,k)=msq(20,j,k)+nfactor*f4q*(
     .+(msq_struc67_5(igg_ab,0,n)+msq_struc67_5(igg_ba,0,n)
     . +msq_struc67_5(igg_sym,0,n))*sub67_5(gq)
     .-(msq_struc67_5v(igg_ab,0,n)+msq_struc67_5v(igg_ba,0,n)
     . +msq_struc67_5v(igg_sym,0,n))*sub67_5v)

      msq(6,j,k)=msq(6,j,k)+(aveqg/avegg)*nfactor/dfloat(nf)*f4q*(
...
c--- we use a factor of 2d0 and msq_struc(iqq_b,...) since
c---  iqq_b = iqq_a (5 <--> 6) and we want qQ->Qq and not qQ->qQ
      msq(1,j,k)=msq(1,j,k)+2d0*dfloat(nf-1)*f4q*(
     .  msq_struc17_2(iqq_b,1,n))*sub17_2(qg)

c--- we use msq_struc(iqq_b,...) since
c---  iqq_b = iqq_a (5 <--> 6) and we want qQ->Qq and not qQ->qQ
      msq(3,j,k)=msq(3,j,k)+2d0*nfactor*f4q*(
...
****************************************************************
      ...
      msq(23,j,k)=msq(23,j,k)+half*f4q*(
     .+(msq_struc75_6(igg_ab,0,n)+msq_struc75_6(igg_ba,0,n)
     . +msq_struc75_6(igg_sym,0,n))*sub75_6(gq)
     .-(msq_struc75_6v(igg_ab,0,n)+msq_struc75_6v(igg_ba,0,n)
     . +msq_struc75_6v(igg_sym,0,n))*sub75_6v)
      msq(1,j,k)=msq(1,j,k)+f4q*(
     .  msq17_2(1,n))*sub17_2(qg)
      msq(3,j,k)=msq(3,j,k)+half/dfloat(nf-1)*f4q*(
...
c--- is artificially stored in msq_struc(iqr,0,0)
     ...
     .  +msq_struc15_2(iqr,0,0))*sub15_2(qg)
      msq(4,j,k)=msq(4,j,k)+(aveqg/avegg)*half/dfloat(nf)*f4q*(
...
**********************************
     ...
     .+msq_struc15_7(igggg_c,j,k)*sub15_7(gg)
     .+msq_struc15_7v(igggg_c,j,k)*sub15_7v
     .+msq_struc15_7(igggg_c,j,k)*sub75_1(gg)*half
     .+msq_struc75_1v(igggg_c,j,k)*sub75_1v*half)
      msq(17,j,k)=two*xn*(
     .+msq_struc15_6(igggg_a,j,k)*sub15_6(gg)
     .+msq_struc15_6v(igggg_a,j,k)*sub15_6v
     .+msq_struc15_6(igggg_a,j,k)*sub65_1(gg)*half
     .+msq_struc65_1v(igggg_a,j,k)*sub65_1v*half
     ...
     .+msq_struc65_1v(igggg_b,j,k)*sub65_1v*half)
      msq(18,j,k)=two*xn*(
     .+msq_struc25_7(igggg_a,j,k)*sub25_7(gg)
     .+msq_struc25_7v(igggg_a,j,k)*sub25_7v
     .+msq_struc25_7(igggg_a,j,k)*sub75_2(gg)*half
     .+msq_struc75_2v(igggg_a,j,k)*sub75_2v*half
     ...
     .+msq_struc25_6(igggg_c,j,k)*sub25_6(gg)
     .+msq_struc25_6v(igggg_c,j,k)*sub25_6v
     .+msq_struc25_6(igggg_c,j,k)*sub65_2(gg)*half
     .+msq_struc65_2v(igggg_c,j,k)*sub65_2v*half)
     ...
     . msq_struc17_5v(igg_ba,j,k),msq_struc17_5v(igg_sym,j,k),sub17_5v)
      msq(9,j,k)=msq(9,j,k)+f2q*sub2q3g_iffi(
     ...
     . msq_struc17_6v(igg_ab,j,k),msq_struc17_6v(igg_sym,j,k),sub17_6v)
      msq(10,j,k)=msq(10,j,k)+f2q*sub2q3g_iffi(
     ...
     . msq_struc27_5v(igg_ab,j,k),msq_struc27_5v(igg_sym,j,k),sub27_5v)
      msq(8,j,k)=msq(8,j,k)+f2q*sub2q3g_iffi(
