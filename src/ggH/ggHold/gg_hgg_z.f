...
c--- NOTE: only including diagonal terms so far
c---          1) check -ve/+ve sign in h4q amplitudes
c---          2) out by a factor of 2 in qqgg amplitudes
c---          3) need to go back to add off-diagonal terms
c---          4) check again once all amplitudes are renormalized
************************************************************************
...
c--- only the iqq_a terms are used for non-identical quarks     
     ...
     .      -one/xn*(if_qq(z,xl15,is)+fi_qq(z,xl15,is))
     .      +two/xn*(ii_qq(z,xl16,is)+ff_qq(z,xl16,is)))
     ...
     .      -one/xn*(ii_qq(z,xl12,is)+ff_qq(z,xl56,is))
     .      -one/xn*(if_qq(z,xl15,is)+fi_qq(z,xl15,is))
     . +(xn+one/xn)*(ii_qq(z,xl16,is)+ff_qq(z,xl16,is)))
     ...
     .      -one/xn*(ii_qq(z,xl12,is)+ff_qq(z,xl56,is))
     .      -one/xn*(if_qq(z,xl26,is)+fi_qq(z,xl26,is))
     . +(xn+one/xn)*(ii_qq(z,xl25,is)+ff_qq(z,xl25,is)))
 
      H1(q,q,a,iqr,is)=H1(q,q,a,iqq_b,is)
      H2(a,a,q,iqr,is)=H2(a,a,q,iqq_b,is)     
     
      H1(g,q,a,igg_ab,is)=ason4pi*two*cf*ii_gq(z,xl16,is)
      H1(g,q,a,igg_ba,is)=H1(g,q,q,igg_ab,is)
      H1(g,q,a,igg_sym,is)=H1(g,q,q,igg_ab,is)
      H2(g,a,q,igg_ab,is)=ason4pi*two*cf*ii_gq(z,xl16,is)
      H2(g,a,q,igg_ba,is)=H2(g,q,q,igg_ab,is)
      H2(g,a,q,igg_sym,is)=H2(g,q,q,igg_ab,is)
...
c--- gluon-quark terms (also used for gluon-antiquark)
     ...
     . -(if_qq(z,xl25,is)+fi_qq(z,xl25,is))*(1d0+1d0/xn**2))
      ...
      H1(q,g,q,iqq_b,is)=H2(q,g,q,iqq_a,is)
      H1(q,g,q,iqq_i,is)=H2(q,g,q,iqq_a,is)

      H1(a,g,q,iqq_a,is)=ason4pi*ii_qg(z,xl12,is)
      H1(a,g,q,iqq_b,is)=H2(a,g,q,iqq_a,is)
      H1(a,g,q,iqq_i,is)=H2(a,g,q,iqq_a,is)

      H2(g,q,g,igggg_a,is)=ason4pi*(aveqg/avegg)*ii_gq(z,xl12,is)
      H2(g,q,g,igggg_b,is)=H1(g,q,g,igggg_a,is)
      H2(g,q,g,igggg_c,is)=H1(g,q,g,igggg_a,is)
