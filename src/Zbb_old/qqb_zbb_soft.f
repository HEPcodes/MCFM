...
c        write(*,*) 'eik57_1*xn',eik57_1*xn*msq0(j,k)
          ...
          msq(j,k)=+(eik17_5+eik57_1)*msq_cs(1,j,k)/2d0*xn
     .             +(eik27_6+eik67_2)*msq_cs(1,j,k)/2d0*xn
     .             +(eik17_2+eik27_1)*msq_cs(1,j,k)/2d0*xn
     .             +(eik27_5+eik57_2)*msq_cs(2,j,k)/2d0*xn
     .             +(eik17_6+eik67_1)*msq_cs(2,j,k)/2d0*xn
     .             +(eik17_2+eik27_1)*msq_cs(2,j,k)/2d0*xn
c--- done with leading colour
     .             -(eik57_6+eik67_5)*msq_cs(1,j,k)/2d0/xn
     .             -(eik57_6+eik67_5)*msq_cs(2,j,k)/2d0/xn
     .             +(eik57_1+eik17_5)*msq_cs(0,j,k)/2d0*xn
     .             +(eik67_2+eik27_6)*msq_cs(0,j,k)/2d0*xn
     .             +(eik67_1+eik17_6)*msq_cs(0,j,k)/2d0*xn
     .             +(eik57_2+eik27_5)*msq_cs(0,j,k)/2d0*xn
c--- done with one gluon QED-like (1/N**2 colour-suppressed)
     .             -(eik57_6+eik67_5)*msq_cs(0,j,k)/2d0*(xn+one/xn)
