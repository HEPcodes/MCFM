      subroutine Cfort8(taucg,taucs,taugs,msq,
...
C     C0(s,c,0,0,msq)
     ...
     &    taucs**(-1)
      ...
      C1=  + epinv * (  - taucs**(-1) )
      C1 = C1 + epinv**2 * (  - 1.D0/2.D0*taucs**(-1) )
      C1 = C1 + lnrat( - taucs,msq)*epinv * ( taucs**(-1) )
      C1 = C1 + lnrat( - taucs,msq)**2 * (  - taucs**(-1) )
      C1 = C1 + lnrat( - taucs,msq) * ( 2.D0*msq*taucs**(-1)*tcs**(-1)
     &     + tcs**(-1) )
      ...
      C1 = C1 + lnrat(musq,msq) * (  - taucs**(-1) )
      C1 = C1 - 1.D0/2.D0*taucs**(-1)*pisqo6 - 2.D0*taucs**(-1) - 
     &    ddilog(msq**(-1)*tcs)*taucs**(-1)

      C2=  + lnrat( - taucs,msq) * (  - tcs**(-1) )

      C11=  + epinv * ( 3.D0/2.D0*taucs**(-1) )
      C11 = C11 + epinv**2 * ( 1.D0/2.D0*taucs**(-1) )
      C11 = C11 + lnrat( - taucs,msq)*epinv * (  - taucs**(-1) )
      C11 = C11 + lnrat( - taucs,msq)**2 * ( taucs**(-1) )
      C11 = C11 + lnrat( - taucs,msq) * (  - 4.D0*msq*taucs**(-1)*
     &    tcs**(-1) + 1.D0/2.D0*msq*tcs**(-2) + msq**2*taucs**(-1)*
     &    tcs**(-2) - 3.D0/2.D0*tcs**(-1) )
     ...
     &    taucs**(-1) )
      ...
      C11 = C11 + lnrat(musq,msq) * ( 3.D0/2.D0*taucs**(-1) )
      C11 = C11 + msq*taucs**(-2) - 1.D0/2.D0*msq*taucs**(-1)*tcs**(-1)
     &     - msq**2*taucs**(-2)*tcs**(-1) + 1.D0/2.D0*taucs**(-1)*
     &    pisqo6 + 3.D0*taucs**(-1) + ddilog(msq**(-1)*tcs)*taucs**(-1)

      C12=  + lnrat( - taucs,msq) * (  - 1.D0/2.D0*msq*tcs**(-2) + 
     &    tcs**(-1) )
      C12 = C12 + 1.D0/2.D0*msq*taucs**(-1)*tcs**(-1) - 1.D0/2.D0*
     &    taucs**(-1)

      C22=  + lnrat( - taucs,msq) * (  - 1.D0/2.D0*msq*tcs**(-2) + 1.D0/
     &    2.D0*tcs**(-1) )
      C22 = C22 + 1.D0/2.D0*msq*taucs**(-1)*tcs**(-1) - 1.D0/2.D0*
     &    taucs**(-1)
