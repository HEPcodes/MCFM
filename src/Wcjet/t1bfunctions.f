      subroutine Cfort1b(taucg,taucs,taugs,msq,
...
C     C0(gs,c,0,0,msq)
      ...
      C1=  + I3me(msq,taugs,qsq)*gramdet**(-1) * ( 2.D0*msq*taugs )
      C1 = C1 + I3me(msq,taugs,qsq) * ( 1.D0 )
      C1 = C1 + lnrat( - taugs,msq)*gramdet**(-1) * (  - taucs - taucg
     &     )
      C1 = C1 + lnrat( - qsqhat,msq)*gramdet**(-1) * ( 2.D0*msq*taucs*
     &    qsq**(-1) + 2.D0*msq*taucg*qsq**(-1) + 6.D0*msq*taugs*
     &    qsq**(-1) + taucs*taugs*qsq**(-1) + taucg*taugs*qsq**(-1) )
      C1 = C1 + lnrat( - qsqhat,msq) * ( qsq**(-1) )

      C2=  + I3me(msq,taugs,qsq)*gramdet**(-1) * (  - taucs*taugs - 
     &    taucg*taugs )
      C2 = C2 + lnrat( - taugs,msq)*gramdet**(-1) * ( 2.D0*taugs )
      C2 = C2 + lnrat( - qsqhat,msq)*gramdet**(-1) * (  - 4.D0*msq*
     &    taugs*qsq**(-1) - 3.D0*taucs*taugs*qsq**(-1) - 3.D0*taucg*
     &    taugs*qsq**(-1) - 2.D0*taugs**2*qsq**(-1) )
      C2 = C2 + lnrat( - qsqhat,msq) * (  - qsq**(-1) )

      C11=  + gramdet**(-1) * (  - 1.D0/2.D0*msq*taucs*qsq**(-1) - 1.D0/
     &    2.D0*msq*taucg*qsq**(-1) + msq - msq**2*qsq**(-1) )
      C11 = C11 + I3me(msq,taugs,qsq)*gramdet**(-2) * (  - 6.D0*msq**2*
     &    taugs**2 )
      C11 = C11 + I3me(msq,taugs,qsq)*gramdet**(-1) * (  - 4.D0*msq*
     &    taugs )
      C11 = C11 + I3me(msq,taugs,qsq) * (  - 1.D0 )
      C11 = C11 + lnrat( - taugs,msq)*gramdet**(-2) * ( 3.D0*msq*taucs*
     &    taugs + 3.D0*msq*taucg*taugs )
      C11 = C11 + lnrat( - taugs,msq)*gramdet**(-1) * ( 3.D0/2.D0*taucs
     &     + 3.D0/2.D0*taucg )
      C11 = C11 + lnrat( - qsqhat,msq)*gramdet**(-2) * (  - 3.D0*msq*
     ...
     &    taugs*qsq**(-1) - 18.D0*msq**2*taugs**2*qsq**(-1) )
      C11 = C11 + lnrat( - qsqhat,msq)*gramdet**(-1) * (  - 7.D0/2.D0*
     &    msq*taucs*qsq**(-1) - 7.D0/2.D0*msq*taucg*qsq**(-1) - 13.D0*
     &    msq*taugs*qsq**(-1) - 1.D0/2.D0*msq**2*taucs*qsq**(-2) - 1.D0/
     &    2.D0*msq**2*taucg*qsq**(-2) + msq**2*qsq**(-1) - msq**3*
     &    qsq**(-2) - 3.D0/2.D0*taucs*taugs*qsq**(-1) - 3.D0/2.D0*taucg
     &    *taugs*qsq**(-1) )
      C11 = C11 + lnrat( - qsqhat,msq) * (  - 3.D0/2.D0*qsq**(-1) )

      C12=  + gramdet**(-1) * ( 1.D0/2.D0*msq*taucs*qsq**(-1) + 1.D0/2.D
     ...
     &    taugs**2 + 3.D0*msq*taucg*taugs**2 )
      C12 = C12 + I3me(msq,taugs,qsq)*gramdet**(-1) * ( taucs*taugs + 
     &    taucg*taugs )
      C12 = C12 + lnrat( - taugs,msq)*gramdet**(-2) * (  - 6.D0*msq*
     &    taugs**2 )
      C12 = C12 + lnrat( - taugs,msq)*gramdet**(-1) * (  - 5.D0/2.D0*
     &    taugs )
     ...
     &    *msq*taugs**3*qsq**(-1) + 12.D0*msq**2*taugs**2*qsq**(-1) )
      C12 = C12 + lnrat( - qsqhat,msq)*gramdet**(-1) * (  - 1.D0/2.D0*
     &    msq*taucs*qsq**(-1) - 1.D0/2.D0*msq*taucg*qsq**(-1) + 6.D0*
     &    msq*taugs*qsq**(-1) + 1.D0/2.D0*msq**2*taucs*qsq**(-2) + 1.D0/
     &    2.D0*msq**2*taucg*qsq**(-2) + msq**2*taugs*qsq**(-2) + 7.D0/2.
     &    D0*taucs*taugs*qsq**(-1) + 7.D0/2.D0*taucg*taugs*qsq**(-1) + 
     &    5.D0/2.D0*taugs**2*qsq**(-1) )
      C12 = C12 + lnrat( - qsqhat,msq) * ( qsq**(-1) )

      C22=  + gramdet**(-1) * ( 1.D0/2.D0*msq*taucs*qsq**(-1) + 1.D0/2.D
     &    0*msq*taucg*qsq**(-1) + msq*taugs*qsq**(-1) - 1.D0/2.D0*taucs
     &     - 1.D0/2.D0*taucg + taugs )
      C22 = C22 + I3me(msq,taugs,qsq)*gramdet**(-2) * (  - 6.D0*msq*
     &    taugs**3 )
      C22 = C22 + I3me(msq,taugs,qsq)*gramdet**(-1) * (  - taugs**2 )
      C22 = C22 + lnrat( - taugs,msq)*gramdet**(-2) * ( 3.D0*taucs*
     &    taugs**2 + 3.D0*taucg*taugs**2 )
      C22 = C22 + lnrat( - qsqhat,msq)*gramdet**(-2) * (  - 6.D0*msq*
     &    taucs*taugs**2*qsq**(-1) - 6.D0*msq*taucg*taugs**2*qsq**(-1)
     &     - 18.D0*msq*taugs**3*qsq**(-1) - 3.D0*taucs*taugs**3*
     &    qsq**(-1) - 3.D0*taucg*taugs**3*qsq**(-1) )
      C22 = C22 + lnrat( - qsqhat,msq)*gramdet**(-1) * (  - 1.D0/2.D0*
     &    msq*taucs*qsq**(-1) - 1.D0/2.D0*msq*taucg*qsq**(-1) + msq*
     &    taugs*qsq**(-1) + 1.D0/2.D0*msq**2*taucs*qsq**(-2) + 1.D0/2.D0
     &    *msq**2*taucg*qsq**(-2) + msq**2*taugs*qsq**(-2) - 1.D0/2.D0*
     &    taucs*taugs*qsq**(-1) - 1.D0/2.D0*taucg*taugs*qsq**(-1) - 4.D0
     &    *taugs**2*qsq**(-1) )
