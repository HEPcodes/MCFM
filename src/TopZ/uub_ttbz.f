      REAL*8 FUNCTION SUUB_TTBZ(P1, P2, P3, P4, P5)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UUB_TTBZ(P1, P2, P3, P4, P5,NHEL(1,IHEL)) 
             SUUB_TTBZ = SUUB_TTBZ + T
          ...
          ENDIF
      ENDDO
      SUUB_TTBZ = SUUB_TTBZ /  4D0 
      END
       
       
      REAL*8 FUNCTION UUB_TTBZ(P1, P2, P3, P4, P5,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      CALL FVIXXX(W1  ,W5  ,GZU,FMASS(3  ),FWIDTH(3  ),W7  )               
      CALL IOVXXX(W7  ,W2  ,W6  ,GG,AMP(1  ))                              
      CALL FVOXXX(W2  ,W5  ,GZU,FMASS(3  ),FWIDTH(3  ),W8  )               
      ...
      DO I = 1, NEIGEN
          ...
          ENDDO
          UUB_TTBZ =UUB_TTBZ+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
