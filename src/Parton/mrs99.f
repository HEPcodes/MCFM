  ...
  98  format('  WARNING:   X  VALUE IS OUT OF RANGE   ')
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor01.dat')
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor02.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor03.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor04.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor05.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor06.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor07.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor08.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor09.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor10.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor11.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
...
c notation: 1=uval 2=val 3=glue 4=usea 5=chm 6=str 7=btm 8=dsea
  ...
  60  continue
     ...
     .        1.8d6,3.2d6,5.6d6,1d7/
      ...
      q2save=qsq
      if(init.ne.0) goto 10
        filename=checkpath('Pdfdata/cor12.dat')
        open(unit=1,file=filename,status='old')
        do 20 n=1,nx-1
        do 20 m=1,nq
        read(1,50)f(1,n,m),f(2,n,m),f(3,n,m),f(4,n,m),
