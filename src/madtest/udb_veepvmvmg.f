      REAL*8 FUNCTION SUDB_VEEPVMVMG(P1, P2, P3, P4, P5, P6, P7)
C  
...
C  
C FOR PROCESS : u d~  -> ve e+ vm vm~ g  
C  
      IMPLICIT NONE
C  
C CONSTANTS
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=UDB_VEEPVMVMG(P1, P2, P3, P4, P5, P6, P7,NHEL(1,IHEL)) 
             SUDB_VEEPVMVMG = SUDB_VEEPVMVMG + T
          ...
          ENDIF
      ENDDO
      SUDB_VEEPVMVMG = SUDB_VEEPVMVMG /  4D0 
      END
       
       
      REAL*8 FUNCTION UDB_VEEPVMVMG(P1, P2, P3, P4, P5, P6, P7,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C  
      ...
      COMPLEX*16 W21(6) , W22(6) , W23(6) , W24(6) 
C  
C GLOBAL VARIABLES
C  
      REAL*8         GW, GWWA, GWWZ
...
C ----------
      ...
      CALL IOVXXX(W10 ,W11 ,W9  ,GZU,AMP(1  ))                             
      CALL FVOXXX(W2  ,W7  ,GG,FMASS(4  ),FWIDTH(4  ),W12 )                
      CALL FVOXXX(W12 ,W8  ,GWF,FMASS(3  ),FWIDTH(3  ),W13 )               
      CALL IOVXXX(W1  ,W13 ,W9  ,GZU,AMP(2  ))                             
      CALL FVIXXX(W1  ,W9  ,GZU,FMASS(3  ),FWIDTH(3  ),W14 )               
      CALL IOVXXX(W14 ,W11 ,W7  ,GG,AMP(3  ))                              
      CALL FVIXXX(W10 ,W8  ,GWF,FMASS(4  ),FWIDTH(4  ),W15 )               
      CALL IOVXXX(W15 ,W2  ,W9  ,GZD,AMP(4  ))                             
      CALL FVIXXX(W1  ,W8  ,GWF,FMASS(4  ),FWIDTH(4  ),W16 )               
      CALL IOVXXX(W16 ,W12 ,W9  ,GZD,AMP(5  ))                             
      CALL FVOXXX(W2  ,W9  ,GZD,FMASS(4  ),FWIDTH(4  ),W17 )               
      CALL IOVXXX(W16 ,W17 ,W7  ,GG,AMP(6  ))                              
      CALL JIOXXX(W10 ,W2  ,GWF,WMASS,WWIDTH,W18 )                         
      CALL FVIXXX(W4  ,W18 ,GWF,FMASS(2  ),FWIDTH(2  ),W19 )               
      CALL IOVXXX(W19 ,W3  ,W9  ,GZN,AMP(7  ))                             
      CALL JIOXXX(W1  ,W12 ,GWF,WMASS,WWIDTH,W20 )                         
      CALL FVIXXX(W4  ,W20 ,GWF,FMASS(2  ),FWIDTH(2  ),W21 )               
      CALL IOVXXX(W21 ,W3  ,W9  ,GZN,AMP(8  ))                             
      CALL FVOXXX(W3  ,W18 ,GWF,FMASS(1  ),FWIDTH(1  ),W22 )               
      CALL IOVXXX(W4  ,W22 ,W9  ,GZL,AMP(9  ))                             
      CALL FVOXXX(W3  ,W20 ,GWF,FMASS(1  ),FWIDTH(1  ),W23 )               
      CALL IOVXXX(W4  ,W23 ,W9  ,GZL,AMP(10 ))                             
      CALL VVVXXX(W18 ,W8  ,W9  ,GWWZ,AMP(11 ))                            
      CALL VVVXXX(W20 ,W8  ,W9  ,GWWZ,AMP(12 ))                            
      CALL FVIXXX(W6  ,W8  ,GWF,FMASS(5  ),FWIDTH(5  ),W24 )               
      CALL IOVXXX(W24 ,W5  ,W18 ,GWF,AMP(13 ))                             
      CALL IOVXXX(W24 ,W5  ,W20 ,GWF,AMP(14 ))                             
      UDB_VEEPVMVMG = 0.D0 
      DO I = 1, NEIGEN
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NGRAPHS
              if ((zerowidth) .and. (((j .gt.6) .and. (j .lt.11))
     .              .or. (j .gt. 12))) then
              continue
              else
          ...
          ENDDO
          UDB_VEEPVMVMG =UDB_VEEPVMVMG+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
