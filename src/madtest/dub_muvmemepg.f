      REAL*8 FUNCTION SDUB_MUVMEMEPG(P1, P2, P3, P4, P5, P6, P7)
C  
...
C ----------
      ...
      DO IHEL=1,NCOMB
          IF (GOODHEL(IHEL) .OR. NTRY .LT. 10) THEN
             T=DUB_MUVMEMEPG(P1, P2, P3, P4, P5, P6, P7,NHEL(1,IHEL)) 
             SDUB_MUVMEMEPG = SDUB_MUVMEMEPG + T
          ...
          ENDIF
      ENDDO
      SDUB_MUVMEMEPG = SDUB_MUVMEMEPG /  4D0 
      END
       
       
      REAL*8 FUNCTION DUB_MUVMEMEPG(P1, P2, P3, P4, P5, P6, P7,NHEL)
C  
C FUNCTION GENERATED BY MADGRAPH
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
C FOR THE POINT IN PHASE SPACE P1,P2,P3,P4,...
...
C ----------
      ...
      CALL FVIXXX(W1  ,W9  ,GAD,FMASS(4  ),FWIDTH(4  ),W15 )               
      CALL IOVXXX(W15 ,W11 ,W7  ,GG,AMP(5  ))                              
      CALL FVIXXX(W1  ,W12 ,GZD,FMASS(4  ),FWIDTH(4  ),W16 )               
      CALL IOVXXX(W16 ,W11 ,W7  ,GG,AMP(6  ))                              
      CALL FVIXXX(W10 ,W8  ,GWF,FMASS(3  ),FWIDTH(3  ),W17 )               
      CALL IOVXXX(W17 ,W2  ,W9  ,GAU,AMP(7  ))                             
      CALL IOVXXX(W17 ,W2  ,W12 ,GZU,AMP(8  ))                             
      CALL FVIXXX(W1  ,W8  ,GWF,FMASS(3  ),FWIDTH(3  ),W18 )               
      CALL IOVXXX(W18 ,W13 ,W9  ,GAU,AMP(9  ))                             
      CALL IOVXXX(W18 ,W13 ,W12 ,GZU,AMP(10 ))                             
      CALL FVOXXX(W2  ,W9  ,GAU,FMASS(3  ),FWIDTH(3  ),W19 )               
      CALL IOVXXX(W18 ,W19 ,W7  ,GG,AMP(11 ))                              
      CALL FVOXXX(W2  ,W12 ,GZU,FMASS(3  ),FWIDTH(3  ),W20 )               
      CALL IOVXXX(W18 ,W20 ,W7  ,GG,AMP(12 ))                              
      CALL JIOXXX(W10 ,W2  ,GWF,WMASS,WWIDTH,W21 )                         
      CALL FVIXXX(W4  ,W21 ,GWF,FMASS(5  ),FWIDTH(5  ),W22 )               
      CALL IOVXXX(W22 ,W3  ,W9  ,GAL,AMP(13 ))                             
      CALL IOVXXX(W22 ,W3  ,W12 ,GZL,AMP(14 ))                             
      CALL JIOXXX(W1  ,W13 ,GWF,WMASS,WWIDTH,W23 )                         
      CALL FVIXXX(W4  ,W23 ,GWF,FMASS(5  ),FWIDTH(5  ),W24 )               
      CALL IOVXXX(W24 ,W3  ,W9  ,GAL,AMP(15 ))                             
      CALL IOVXXX(W24 ,W3  ,W12 ,GZL,AMP(16 ))                             
      CALL FVOXXX(W3  ,W21 ,GWF,FMASS(6  ),FWIDTH(6  ),W25 )               
      CALL IOVXXX(W4  ,W25 ,W12 ,GZN,AMP(17 ))                             
      CALL FVOXXX(W3  ,W23 ,GWF,FMASS(6  ),FWIDTH(6  ),W26 )               
      CALL IOVXXX(W4  ,W26 ,W12 ,GZN,AMP(18 ))                             
      CALL VVVXXX(W8  ,W21 ,W9  ,GWWA,AMP(19 ))                            
      CALL VVVXXX(W8  ,W21 ,W12 ,GWWZ,AMP(20 ))                            
      CALL VVVXXX(W8  ,W23 ,W9  ,GWWA,AMP(21 ))                            
      CALL VVVXXX(W8  ,W23 ,W12 ,GWWZ,AMP(22 ))                            
      CALL FVIXXX(W6  ,W8  ,GWF,FMASS(2  ),FWIDTH(2  ),W27 )               
      CALL IOVXXX(W27 ,W5  ,W21 ,GWF,AMP(23 ))                             
      CALL IOVXXX(W27 ,W5  ,W23 ,GWF,AMP(24 ))                             
      DUB_MUVMEMEPG = 0.D0 
      DO I = 1, NEIGEN
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NGRAPHS
          ...
          ENDDO
          DUB_MUVMEMEPG =DUB_MUVMEMEPG+ZTEMP*EIGEN_VAL(I)*CONJG(ZTEMP) 
      ENDDO
