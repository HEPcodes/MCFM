...
c---    added decay: J. Campbell, May 2011 
     ...
     &   dot,projb,projt,wprop12,wprop21,mq,ma,gsq_L,gsq_H,s345,fac
      double complex gs1(2,2,2,2),gs2(2,2,2,2),gs1dk(2,2,2),gs2dk(2,2,2)
      integer i,j,k
...
c used in the call to the reals1)
      ...
      do i=1,4
         pp(t1,i)=pp(3,i)+pp(4,i)+pp(5,i)-pp(proj,i)*mt**2/2d0/projt
         pp(b1,i)=pp(6,i)-pp(proj,i)*mb**2/2d0/projb
      enddo
